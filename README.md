...
当前主表包含 250 家公司，全部拥有至少一种有效联系方式，平均成本为 ¥1.45/家。其中 188 家拥有有效邮箱，成本为 ¥1.92/家；196 家拥有有效电话，成本为 ¥1.84/家。覆盖结构为：134 家邮箱和电话都有、54 家只有邮箱、62 家只有电话、0 家两者都没有。
...
- 必须显式加 `--execute` 才执行。
- 当前项目累计上限为 ¥500，每个付费脚本都在请求前做预算拦截；当前累计费用为 ¥361.60。
